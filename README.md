...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/tmullen/dotfiles/custom/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tmullen/dotfiles/custom/install.sh`" -s ask
```
